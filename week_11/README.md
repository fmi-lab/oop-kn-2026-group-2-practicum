# Week 11: Виртуални методи и още наследяване
...
- Създайте т. нар. "виртуален копиращ конструктор" за всеки от класовете, който да връща копие на обекта, върху който е извикан.
